...
def home():
    if request.method == 'POST':
        ...
        if symptoms == "Symptoms" or not symptoms.strip():
            ...
            my_precautions = [p for p in precautions]
            my_medications = [m for m in medications]
            my_diet  =       [d for d in my_diet]
            my_workout =     [w for w in workout ]

            

            return render_template('predict.html', predicted_disease=predicted_disease,
                                   dis_des=dis_des, my_precautions=my_precautions,
                                   my_medications=my_medications, my_diet=my_diet,
